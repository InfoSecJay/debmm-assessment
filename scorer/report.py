...
Generates a markdown report from scored assessment results. Can be used
standalone or imported by score.py.
...
def generate_report(results: dict) -> str:
    ...
    lines.append("---")
    lines.append("")
    lines.append("*Generated by [DEBMM Assessment Tool](https://github.com/InfoSecJay/debmm-assessment). "
